...
for {set i 0} {$i < $num_flow} {incr i} {
	...
	#$ns at 0.2 "plotThroughput $tcp($i) $outfile"
}

# proc plotThroughput {tcp_sink outfile} {
#    global ns

#    set now [$ns now]
#    set nbytes [$tcp_sink set bytes_]
#    $tcp_sink set bytes_ 0
...
#    $ns at [expr $now+$time_incr] "plotThroughput $tcp_sink  $outfile"
# }
